...
export function Index() {
  return(
    <>
      <motion.div initial={{scale: 0}}  animate={{scale: 1, transition: {delay: 0.1}}} className="bg-gradient-to-l from-red-400 to-orange-500 w-full h-full min-h-[calc(100vh-5rem)]">
      <div className="relative">
        ...
        <motion.img initial={{opacity: 0}} animate={{opacity: 0.2, transition: {delay: 0.7}}}  src="store.png" alt="" className="absolute right-0 left-0 top-0 bottom-0 h-full m-auto -z-1 opacity-20" />
      </div>
      <div className="p-4 gap-4 flex flex-col items-center flex-wrap md:justify-center md:flex-row">
        ...
        <Card title={"Módulo de control de calidad y auditoria"} animation_delay={1.4} />
        <Card title={"Módulo de fidelización y marketing"} image={"fidelizacion.png"} route={"/fidelizacion"} animation_delay={1.5}/>
      </div>
      </motion.div>
