...
export function Administracion() {
  ...
  const validarAdministracion = (administrador) => {
    ...
    if (!area_Trabajo) {
      //alert("Seleccione un area de trabajo para el administrador.");
                  ...
                  {listaAdministradores.length > 0 ? (
                    listaAdministradores.map((administrador, index) => (
                      <tr key={administrador.id_empleado} className={index % 2 === 0 ? "bg-gray-100" : "bg-gray-200"}>
                        ...
                        <td className="py-2 px-4 border-b text-center">{administrador.fechaDe_Alta}</td>
                        <td className="py-2 px-4 border-b text-center">{administrador.ultimo_acceso}</td>
                        <td className="py-2 px-4 border-b text-center">
