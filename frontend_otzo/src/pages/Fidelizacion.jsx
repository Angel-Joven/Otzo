                ...
                <table className="min-w-full bg-white">
                  <thead>
                    <tr>
                      ...
                      <th className="py-2 px-3 border-b text-center">Cuenta Habilitada</th>
                    </tr>
                  </thead>
                    <tbody>
                      {clientes.slice(0, 1).map((cliente, index) => {
                        ...
                        return (
                          <tr key={cliente.idCliente} className={index % 2 === 0 ? 'bg-gray-100' : 'bg-gray-200'}>
                            ...
                            <td className="py-2 px-4 border-b text-center">{puntosCliente && puntosCliente.habilitado ? 'SI' : 'NO (Este cliente NO puede obtener rangos ni puntos debido al estado de su cuenta)'}</td>
                          </tr>
                        );
                      })}
                    </tbody>
