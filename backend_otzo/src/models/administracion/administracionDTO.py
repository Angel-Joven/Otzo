# DTO para el Modulo de Administracion
...
class AdministracionDTO(Serializable):
    def __init__(self, id_empleado=None, nombre=None, apellido_paterno=None, apellido_materno=None, fecha_nacimiento=None, genero=None, direccion_calle=None, direccion_colonia=None, direccion_codigopostal=0, direccion_estado=None, direccion_municipio=None, contacto_correo=None, contraseña=None, contacto_telefono=None, area_Trabajo=None, fechaDe_Alta=None, ultimo_acceso=None, estado_cuenta=None):
    ...
    def id_empleado(self, value):
        if value is not None and value < 0:
            raise ValueError("El ID del empleado no puede ser negativo")
    ...
    @area_Trabajo.setter
    def area_Trabajo(self, value):
        if not value:
            raise ValueError("Esta area trabajo no puede ser vacio")
        self._area_Trabajo = value
...
print("---------------------------------------------------------------------------------------------------------------------------")
print("Administracion DTO")

# AdministracionDTO - EJEMPLO TEST
administracion_dto = AdministracionDTO(
    id_empleado=1,
    nombre="Angel Cristian",
    apellido_paterno="Joven",
...
json_data = administracion_dto.to_json()
print("JSON:", json_data)
#JSON: {"_id_empleado": 1, "_nombre": "Angel Cristian", "_apellido_paterno": "Joven", "_apellido_materno": "Jimenez", "_fecha_nacimiento": "2002-05-19", "_genero": "Masculino", "_direccion_calle": "Calle Falsa 123", "_direccion_colonia": "Centro", "_direccion_codigopostal": 12345, "_direccion_estado": "Ciudad de M\u00e9xico", "_direccion_municipio": "Cuauht\u00e9moc", "_contacto_correo": "juan.perez@example.com", "_contrase\u00f1a": "pass1234", "_contacto_telefono": "5551234567", "_area_Trabajo": "Fidelizacion", "_fechaDe_Alta": "2024-11-20 08:00:00", "_ultimo_acceso": "2024-11-20 10:00:00", "_estado_cuenta": "Activo"}

#Reconstruimos desde un JSON - EJEMPLO TEST
nuevo_administracion_dto = AdministracionDTO.from_json(json_data)
print("Nuevo DTO:", nuevo_administracion_dto.to_dict())
#Nuevo DTO: {'_id_empleado': 1, '_nombre': 'Angel Cristian', '_apellido_paterno': 'Joven', '_apellido_materno': 'Jimenez', '_fecha_nacimiento': '2002-05-19', '_genero': 'Masculino', '_direccion_calle': 'Calle Falsa 123', '_direccion_colonia': 'Centro', '_direccion_codigopostal': 12345, '_direccion_estado': 'Ciudad de México', '_direccion_municipio': 'Cuauhtémoc', '_contacto_correo': 'juan.perez@example.com', '_contraseña': 'pass1234', '_contacto_telefono': '5551234567', '_area_Trabajo': 'Fidelizacion', '_fechaDe_Alta': '2024-11-20 08:00:00', '_ultimo_acceso': '2024-11-20 10:00:00', '_estado_cuenta': 'Activo'}

print("ID del empleado:", administracion_dto.id_empleado)
print("Nombre del empleado:", administracion_dto.nombre)
print("Correo del empleado:", administracion_dto.contacto_correo)
print("Area de trabajo del empleado:", administracion_dto.area_Trabajo)
